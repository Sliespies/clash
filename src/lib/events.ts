...
export interface GameEvent {
  ...
  lowerIsBetter?: boolean; // for non-time events where lower score = better (e.g. Piccoo)
...
export const EVENTS: GameEvent[] = [
  ...
  { name: 'Icaros', type: 'number', label: 'Doolhoven', desc: 'Voer het aantal doolhoven in', icon: '/path.svg', phase: 1, shared: true, needsParticipants: true, max: 15 },
  ...
  { name: 'Streetracket', type: 'number', label: 'Gescoorde ballen', desc: 'Voer het aantal gescoorde ballen in', icon: '/tennis-ball.svg', phase: 3, shared: true, max: 20 },
  // Fase 4 — Gezamenlijk
  { name: 'Piccoo', type: 'number', label: 'Getikten', desc: 'Voer het aantal getikten in', icon: '/hand-pointing.svg', phase: 4, shared: true, lowerIsBetter: true },
];
